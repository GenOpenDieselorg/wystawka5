    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.requires2FA) {
          ...
          // Po 5 nieudanych próbach zresetuj widget Turnstile
          if (newFailedAttempts >= 5) {
            setTurnstileKey(prev => prev + 1);
            setFailedAttempts(0);
            setError('Zbyt wiele nieudanych prób logowania. Weryfikacja antybotowa została zresetowana. Spróbuj ponownie.');
          }
        }
      }
    } finally {
